...
def calc_deterioro(
    ...
    deterioro_pcr = (
        ...
        .with_columns(
            (
                pl.col("prob_incumplimiento_actual")
                - pl.col("prob_incumplimiento_anterior")
    ...
    delta_pd = (
        ...
        .then(pl.col("prob_incumplimiento_actual"))
        .otherwise("cambio_prob_incumplimiento")
    )
    ...
    lib_cambio_saldo = pl.min_horizontal(
        pl.col("saldo") - pl.col("saldo_anterior"), pl.lit(0.0)
    ) * pl.col("prob_incumplimiento_anterior")
    # se libera si baja la probabilidad
    lib_cambio_pd = pl.min_horizontal(
        pl.col("cambio_prob_incumplimiento"), pl.lit(0.0)
    ) * pl.col("saldo")
