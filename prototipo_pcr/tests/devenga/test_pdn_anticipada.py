...
def test_pdn_anticipada_valorada_antes_de_vigencia(
    param_contabilidad: pl.DataFrame, excepciones_df: pl.DataFrame
):
    """
...
def test_pdn_anticipada_valorada_despues_de_vigencia(
    param_contabilidad: pl.DataFrame, excepciones_df: pl.DataFrame
):
    """
    Valoracion de PCR para produccion anticipada en un mes posterior al
...
def test_pdn_anticipada_50_50_enero_marzo(
    param_contabilidad: pl.DataFrame, excepciones_df: pl.DataFrame
):
    """
    ...
    fechas = cf.Fechas(
        ...
        fecha_contabilizacion_recibo=date(2025, 1, 22),
